...
export default function AboutServices() {
  ...
  return (
    <section id="about" className="py-16 md:py-20 lg:py-32 bg-background text-offwhite overflow-hidden border-b border-[#374151]">
      <div className="section-container flex flex-col md:flex-row gap-8 md:gap-12 lg:gap-16 xl:gap-24">
              ...
              >
                {services.map((item, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="h-[80px] flex items-center cursor-pointer px-2"
        ...
        <div className="flex-1 flex flex-col justify-center h-auto md:h-full md:pl-8 mt-4 md:mt-0">
          <SectionHeading className="mb-8 font-oswald text-4xl md:text-5xl">Who Am I</SectionHeading>
          <p className="font-inter text-2xl md:text-3xl leading-[1.6] text-gray-400 font-light tracking-tight max-w-2xl">
            Hi, I'm Tofi. I bridge the gap between <strong className="text-offwhite font-normal">beautiful brand design</strong> and <strong className="text-offwhite font-normal">high-performance code</strong>. I build custom, frictionless website experiences that allow ambitious brands to scale without technical headaches.
          </p>
        </div>
      </div>
    </section>
