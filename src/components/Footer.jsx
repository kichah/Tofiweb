    ...
    <footer className=' bg-background pt-20 pb-12 border-t border-white/5 relative z-10 -mt-10'>
      ...
      <div className='section-container flex flex-col md:flex-row justify-between gap-16 mt-10'>
        ...
        <div className='flex-1'>
          <h3 className='font-oswald text-2xl text-offwhite mb-8 tracking-wider uppercase'>
            Stay Connected
          </h3>
          <div className='flex gap-4 text-gray-400'>
            <a
              href='#'
              className='w-12 h-12 rounded-full border border-gray-700 flex items-center justify-center hover:bg-primary hover:text-black hover:border-primary transition-all duration-300'
            >
              <Instagram size={20} />
            </a>
            <a
